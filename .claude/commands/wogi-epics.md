...
### List Epics
```bash
node node_modules/wogiflow/scripts/flow-epics.js list
# or: flow epics list
```

### Create Epic
```bash
node node_modules/wogiflow/scripts/flow-epics.js create <epicId> --title "Title" --desc "Description"
```

Example:
```bash
node node_modules/wogiflow/scripts/flow-epics.js create epic-auth --title "Authentication System" --desc "Complete user authentication implementation"
```

### Add Story to Epic
```bash
node node_modules/wogiflow/scripts/flow-epics.js add-story <epicId> <storyId>
```

Example:
```bash
node node_modules/wogiflow/scripts/flow-epics.js add-story epic-auth wf-abc123
```

### View Epic Details
```bash
node node_modules/wogiflow/scripts/flow-epics.js show <epicId>
```

### View Full Hierarchy Tree
```bash
node node_modules/wogiflow/scripts/flow-epics.js tree <epicId>
```
...
node node_modules/wogiflow/scripts/flow-epics.js update <epicId>

# Update all epics
node node_modules/wogiflow/scripts/flow-epics.js update
```

### Remove Story from Epic
```bash
node node_modules/wogiflow/scripts/flow-epics.js remove-story <epicId> <storyId>
```

### Delete Epic
```bash
node node_modules/wogiflow/scripts/flow-epics.js delete <epicId>
```
...
node node_modules/wogiflow/scripts/flow-epics.js create epic-dashboard --title "Analytics Dashboard"
...
node node_modules/wogiflow/scripts/flow-epics.js add-story epic-dashboard wf-charts-123
node node_modules/wogiflow/scripts/flow-epics.js add-story epic-dashboard wf-filter-456

# 4. Work on tasks (stories auto-decompose into tasks)
/wogi-start wf-charts-task-001

# 5. Check progress
node node_modules/wogiflow/scripts/flow-epics.js tree epic-dashboard
```
