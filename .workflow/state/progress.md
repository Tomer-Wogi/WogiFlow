...
```json
{
  ...
  "keyFacts": [
    ...
    "Completed: Research-required gate misses project-specific factual/locational questions — 'where does X live in this project' classified Tier-1 'answer directly', no Read forced, model answers from prior and doubles down (wogiflow-cli incident 2026-05-12)"
  ],
  "lastUpdated": "2026-05-12T08:24:22.143Z",
  "taskQueueSnapshot": {
    "readyCount": 0,
    "inProgressCount": 1,
    "blockedCount": 0,
