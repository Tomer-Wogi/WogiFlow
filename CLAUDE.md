...
/wogi-start "add feature X"
    ...
    |   - Update app-map.md (add new, remove deleted, update renamed components)
    |   - Update function-map.md (add new, prune orphans via scan)
...
Last synced: 2026-02-21T22:14:01.668Z
